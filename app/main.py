                ...
                if data.startswith("setlang:"):
                    ...
                    try:
                        ...
                        if payment.provider == "stripe":
                            ...
                            # Crypto fallback: show invoice URL if provided; otherwise show address/details
                            ...
                            # PIX (Asaas): send QR image (if available) + copy/paste code + a "check" button.
                            ...
                            kb = InlineKeyboardMarkup(
                                [[InlineKeyboardButton(get_text("btn_check_payment", lang), callback_data=f"checkpay:{payment.provider}:{payment.external_id}")]]
                            )
                            await self.safe_edit_or_send(query, msg, reply_markup=kb, parse_mode=ParseMode.MARKDOWN)
                    except Exception as e:
