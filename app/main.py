...
"""
Main bot module - Package Architecture
...
async def run_bot():
    ...
    Uses package-relative imports for stability.
    """
    logger.info("🚀 Starting Bot in Package Mode...")
    
    try:
        # Importações dentro do pacote 'app'
        ...
        # Use a custom updater if on Python 3.13 to avoid the slots bug
        # but for Railway/Production stability, we just ensure it builds correctly
        app = builder.build()
        
        # Access the bot after building
        bot = app.bot
