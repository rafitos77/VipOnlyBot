                ...
                if data.startswith("setlang:"):
                    ...
                    try:
                        ...
                        if user_db.is_payment_already_paid(provider, external_id):
                            await query.edit_message_text(get_text("payment_confirmed", lang))
                            return
                        ...
                        if status == "paid":
                            ...
                            await query.edit_message_text(get_text("payment_pending", lang))

                    except Exception as e:
                        logger.exception("Payment status check failed")
                        await query.edit_message_text(get_text("payment_error", lang) + f"\n\n{e}")
