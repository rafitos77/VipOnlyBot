...
"""
Main bot module - v8.1 Fixed Edition
...
async def run_bot():
    ...
    """
    logger.info("🚀 Starting Bot in v8.1 Fixed Mode...")
    ...
    try:
        ...
        class VIPBotUltra:
            ...
            async def cmd_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
                ...
                # Use effective_message for compatibility between Message and CallbackQuery
                ...
                if not u_data.get('language') or (context.args and 'lang' in context.args):
                    ...
                    try:
                        ...
                        # Add a safety timeout for the visual welcome
            ...
            async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
                ...
                if text == get_text("btn_search", lang):
                    ...
                    mode_text = "GOD (Acesso Total)" if new_status == 1 else "NORMAL (Teste de Usuário)"
                    await update.message.reply_text(
