...
TRANSLATIONS = {
    "pt": {
        ...
        "crypto_unavailable_plan": "⚠️ Cripto está indisponível para este plano (mínimo da rede). Escolha PIX ou selecione um plano maior.",
    ...
    "es": {
        ...
        "crypto_unavailable_plan": "⚠️ Cripto no está disponible para este plan (mínimo de la red). Elige otro método o un plan mayor.",
    ...
    "en": {
        ...
        "crypto_unavailable_plan": "⚠️ Crypto is unavailable for this plan (network minimum). Choose another method or a higher plan.",
